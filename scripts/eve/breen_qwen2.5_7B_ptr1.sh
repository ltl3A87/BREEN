...
export DATA_PATH=playground/data/BREEN-Pretrain/breen_pretrain_blip3_9m.json
export IMAGE_PATH=playground/data/EVE-Pretrain
export VIT_PATH=openai/eve-patch14-anypixel-672
export VIT_PATH_CLIP=openai/clip-vit-large-patch14-336
export BASE_LR=4e-5

export CKPT_PATH=checkpoints/breen-qwen25-7B-prtr0
export SAVE_PATH=breen-qwen25-7B-prtr1
