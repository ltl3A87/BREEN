...
class CustomDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        image_tensor, image_raw = process_images([image], self.image_processor, None, True)
        ...
        return input_ids, image_tensor, image_raw
...
def eval_model(args):
    ...
    for (input_ids, image_tensor, image_raw), line in tqdm(zip(data_loader, questions), total=len(questions)):
        ...
        image_token_length = grid_height * grid_width
        ...
        for i, layer in enumerate(outputs_dict["attentions"][0]):
            ...
            if i == 1 or i == 13 or i ==26:
                ...
                for i, ax in enumerate(axes.flatten()):
                    ...
                    attn_weights_over_vis_tokens = cur_attn[target_token_ind][vision_token_start:vision_token_end]
                    ...
                    attn_over_image = attn_over_image.reshape(grid_height, grid_width)
                    ...
                    ax.axis("off")
                plt.savefig(f"att_viz_twosample/{idx}_try_image_viz_layer{layer_idx}_v3.jpg")
            # break
    ans_file.close()
